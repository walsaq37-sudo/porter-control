const CACHE='porter-control-v36';
...
self.addEventListener('fetch',e=>{
 if(e.request.mode==='navigate'){
  e.respondWith(fetch(e.request,{cache:'no-store'}).then(async r=>{
   ...
   const scripts=['connection-bootstrap.js?v=2','shared-inventory-fix.js?v=2','shared-inspections.js?v=2','shared-missing.js?v=3','shared-containers.js?v=5','team-shifts.js?v=4','supervisory-view.js?v=7','team-messages.js?v=2','team-login.js?v=2'];
