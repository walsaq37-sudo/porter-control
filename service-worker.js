const CACHE='porter-control-v31';
const ASSETS=['./','index.html','manifest.json','milk-semi.svg','milk-oat.svg','shared-inspections.js','shared-missing.js','shared-containers.js','team-shifts.js','supervisory-view.js','team-messages.js','team-login.js'];
