const CACHE='porter-control-v21';
const ASSETS=['./','index.html','manifest.json','milk-semi.svg','milk-oat.svg','shared-inspections.js','shared-missing.js','shared-containers.js'];
