(function(){
  ...
  function porterDetail(n){
    ...
    box.innerHTML=`<h2>👷 ${n}</h2><button class="back" id="porterBack">← Back to team</button><div class="muted" style="margin-top:10px">Today's shared activity</div>`+
    ...
    document.getElementById('porterBack').onclick=renderSupervisorDashboard;
  }
  async function renderSupervisorDashboard(){
    ...
    box.querySelectorAll('.porter-detail').forEach(b=>b.onclick=()=>porterDetail(b.dataset.porter));
  }
